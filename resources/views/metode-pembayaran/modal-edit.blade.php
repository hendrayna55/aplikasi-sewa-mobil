                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="nama_metode" id="nama_metode" class="form-control select2" style="width: 100%;" required>
                                ...
                                @foreach ($banks as $bank)
                                    <option value="{{$bank['name']}}" data-code="{{$bank['code']}}" {{(old('nama_metode', $data->nama_metode) == $bank['name']) ? 'selected' : ''}}>{{$bank['name']}}</option>
                                @endforeach
                            </select>
                        </div>

                        <input type="hidden" name="logo_metode" id="logo_metode" class="form-control" value="{{$data->logo_metode}}" required/>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="pemilik_rekening" id="pemilik_rekening" class="form-control" value="{{$data->pemilik_rekening}}" required/>
                        </div>
                    </div>
                </div>
            </div>
