...
@section('title')
    {{Auth::user()->role_id == 1 ? 'Data Pengembalian' : 'Pengembalianku'}}
@endsection
...
@php
    $url = Auth::user()->role_id != 1 ? '/get-data/pengembalianku/' . $user->id : '/get-data/pengembalian';
@endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="${item.status_pembayaran == 'Unpaid' ? 'text-danger' : 'text-primary'}">
                                            ${item.status_pembayaran} ${
                                                item.status_pembayaran == 'Paid' ? `<span class="${item.status_verifikasi == 'Unverified' ? 'text-danger' : 'text-success'}">(${item.status_verifikasi})</span>` : ''
                                            }
                                        </td>
